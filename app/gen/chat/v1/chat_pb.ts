...
export const file_chat_v1_chat: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp]);
...
export type CreateConversationRequest = Message$1<"chat.v1.CreateConversationRequest"> & {
  ...
  /**
   * @generated from field: optional string trait = 2;
   */
  trait?: string;
};
...
export type UpdateConversationRequest = Message$1<"chat.v1.UpdateConversationRequest"> & {
  ...
  /**
   * @generated from field: optional string trait = 3;
   */
  trait?: string;
};
...
/**
 * @generated from message chat.v1.GetInfoRequest
 */
export type GetInfoRequest = Message$1<"chat.v1.GetInfoRequest"> & {
};

/**
 * Describes the message chat.v1.GetInfoRequest.
...
/**
 * @generated from message chat.v1.TraitInfo
 */
export type TraitInfo = Message$1<"chat.v1.TraitInfo"> & {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
...
/**
 * Describes the message chat.v1.TraitInfo.
 * Use `create(TraitInfoSchema)` to create a new message.
 */
export const TraitInfoSchema: GenMessage<TraitInfo> = /*@__PURE__*/
  messageDesc(file_chat_v1_chat, 22);

/**
 * @generated from message chat.v1.GetInfoResponse
 */
export type GetInfoResponse = Message$1<"chat.v1.GetInfoResponse"> & {
  /**
   * @generated from field: repeated chat.v1.TraitInfo traits = 1;
   */
  traits: TraitInfo[];

  /**
   * @generated from field: string default_trait = 2;
   */
  defaultTrait: string;
};

/**
 * Describes the message chat.v1.GetInfoResponse.
...
export const ChatService: GenService<{
   ...
   * Info
   *
   * @generated from rpc chat.v1.ChatService.GetInfo
   */
  getInfo: {
    methodKind: "unary";
